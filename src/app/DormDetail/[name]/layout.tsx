            ...
            <div className="flex justify-between items-center h-[80px] z-10">
                <div className="flex flex-row ">
                    <Link href="/Home">
                        ...
                        <Image className="w-28 h-20" src='/logo.png' alt="logo" width={112} height={80} />
                    </Link>
                    <div className="flex items-center mx-8">
                        ...
                        <Link href="/Books" className="mx-4 text-base transition-all duration-200 ease-out hover:font-semibold hover:underline">My booking</Link>
