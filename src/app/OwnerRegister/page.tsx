...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch('https://ep32zucumj.execute-api.ap-southeast-1.amazonaws.com/default/AdminRegister', {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen bg-white p-6">
      ...
      <div className="relative w-full">
        ...
        <div className="text-center mb-8">
          <h2 className="text-black text-2xl font-bold mb-2">Create your Owner account !</h2>
          ...
          <div>
            ...
            <div className="relative max-w-sm mx-auto">
              ...
              <input
                ...
                placeholder="name"
                className="text-black w-full pl-10 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-yellow-400 focus:border-transparent"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative max-w-sm mx-auto">
              ...
              <input
                ...
                className="text-black w-full pl-10 pr-10 py-2 border rounded-lg focus:ring-2 focus:ring-yellow-400 focus:border-transparent"
              />
              <button
                type="button"
          ...
          <div>
            ...
            <div className="relative max-w-sm mx-auto">
              ...
              <input
                ...
                className="text-black w-full pl-10 pr-10 py-2 mb-7 border rounded-lg focus:ring-2 focus:ring-yellow-400 focus:border-transparent"
              />
              <button
                type="button"
