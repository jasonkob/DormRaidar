...
export default function userLayout({
    ...
    return(
        <div className="px-4 py-2 pt-10flex flex-col justify-center h-screen overflow-hidden ">
            <div className="flex justify-between items-center h-[80px] z-10">
                <div className="flex flex-row ">
                    ...
                    <div className="flex items-center mx-8">
                        ...
                        <Link href="/Mybooking" className="mx-4 text-base transition-all duration-200 ease-out hover:font-semibold hover:underline">My booking</Link>
                    ...
                    {shwMenu && (
                        <div className="absolute -bottom-[175px] right-0 w-[200px] h-[165px] border bg-white rounded-lg">
                            <ul className="border-b-2 mt-1">
                                <li className="cursor-pointer select-none transition duration-150 ease-in-out  hover:bg-yellow-200 "><Link href="/signup"><p  className="px-4 py-2 text-[14px] font-semibold">Sign up</p></Link></li>
                            ...
                            <ul className=" mt-1 mb-1">
                                <li className="cursor-pointer select-none transition duration-150 ease-in-out  hover:bg-yellow-200 "><Link href="/signup" ><p className="px-4 py-2 text-[14px]">Become Dorm Admin</p></Link></li>
