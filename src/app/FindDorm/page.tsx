                            ...
                            {shwLocation && (
                                <div className="absolute -bottom-[125px] -left-0 w-full shadow-lg rounded-md bg-white z-10">
                                    ...
                                    {allLocation.map((item,index)=>(
                                                <li className='p-2 pl-3 rounded-md cursor-pointer select-none transition duration-100 ease-in hover:bg-yellow-200' key={index} onClick={()=>selectLocation({location:item.content})}>{item.content}</li>
                                            ))}
                                    </ul>
                                </div>
                            )}
                            ...
                            {shwPrice && (
                                <div className="absolute -bottom-[125px] -left-0 w-full shadow-lg rounded-md bg-white z-10">
                                    ...
                                    {allPrice.map((item,index)=>(
                                                <li className='p-2 pl-3 rounded-md  cursor-pointer select-none transition duration-100 ease-in hover:bg-yellow-200' key={index} onClick={()=>selectPrice({price:item.price})}>{item.price}</li>
                                            ))}
                                    </ul>
                                </div>
                            )}
                            ...
                            {shwType && (
                                <div className="absolute -bottom-[125px] -left-0 w-full shadow-lg rounded-md bg-white z-10">
                                    ...
                                    {allType.map((item,index)=>(
                                                <li className='p-2 pl-3 rounded-md cursor-pointer select-none transition duration-100 ease-in hover:bg-yellow-200' key={index} onClick={()=>selectType({type:item.content})}>{item.content}</li>
                                            ))}
                                    </ul>
                                </div>
                            )}
